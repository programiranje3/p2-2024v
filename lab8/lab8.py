...
if __name__ == '__main__':
    ...
    # # Zadatak 1
    # analiza_fajlova_sa_slikama(get_data_dir() / 'image_files_for_training.txt')
    #
    ...
    #
    # podaci_o_timu = ucitaj_iz_csv_fajla(get_results_dir() / 'podaci_o_timu.csv')
    ...
    #
    # # Zadatak 3
    # f1 = get_data_dir() / 'happy_numbers.txt'
    # f2 = get_data_dir() / 'prime_numbers.txt'
